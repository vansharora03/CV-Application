...
export default class Education extends React.Component {
    ...
    render() {
        ...
        const editable = (<div className="qualificationSection">
            ...
            <EducationView submitted={submitted} educationList={educationList} deleteEducation={this.deleteEducation}/>
        ...
        const notEditable = (<div className="qualificationSection">
            <h1 className="title">Education</h1>
            <EducationView submitted={submitted} educationList={this.state.educationList}/>
        </div>)
